...
const Profile = () => {
  ...
  const { isLoading, personalProfile, serviceProfile } = useSelector(
    (store) => store.profile
  );
    ...
    <div className="profile bg-white text-black relative">
      ...
      <div className="relative mt-16">
        <header className="profile-header">
          ...
          />
          <div className="absolute text-white z-20 w-full h-full top-0 left-0 text-center flex flex-col gap-4 justify-center items-center">
              ...
              <>
                ...
                <ol className="flex flex-col gap-4">
                  <small className="text-primary">
                    ...
                    {serviceProfile.services?.length})
                  </small>
                  <hr />
